        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nom du fichier ou nom d'usage du clip" aria-describedby="titrevideo">
                </div>
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" placeholder="2013" aria-describedby="jtxvideo">
                        </div>
                    </div>
                    <div class='col-md-6'>
                        <div class="input-group">
                            <span class="input-group-addon" id="anneevideo">Année</span>
                            <input type="number" class="form-control" placeholder="2013" aria-describedby="anneevideo">
                        </div>
                    </div>
                </div>
                <hr style='margin-top:10px;margin-bottom:10px'>
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" placeholder="2013;2012" aria-describedby="promotionsvideo">
                </div>
                <hr style='margin-top:10px;margin-bottom:10px'>
                <p class='text-muted'>Idem pour les catégories.</p>
                <div class="input-group">
                    <span class="input-group-addon" id="categoriesvideo">Catégorie(s)</span>
                    <input type="number" class="form-control" placeholder="2013;2012" aria-describedby="categoriesvideo">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Listes de mots sans majuscules ni accents séparés par des espaces" aria-describedby="titrevideo">
                </div>
                <hr style='margin-top:10px;margin-bottom:10px'>
