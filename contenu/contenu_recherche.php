...
?>
<div class="container-fluid" style="float:left; border: solid black 1px; position:fixed; z-index:10;
     border-radius:0px; width:150px; margin-left:10px; ">
    <p>Catégories</p>
</div>
...
for ($i = $offset;
$i <= min(count($resultats) - 1, $offset + $itemsparpage - 1);
$i++) {//attention les pages commencent à 1 mais le tableau des résltats est indexé à partir de 0.
